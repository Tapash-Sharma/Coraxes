...
def run_all_models(dfnew):
    models = {
        #"Bagged Decision Tree": 'pickle_files/bagged_decision_tree.pkl',
        "Random Forest": 'pickle_files/random_forest.pkl',
        #"Extra Trees": 'pickle_files/extra_trees.pkl',
        #"Adaboost": 'pickle_files/adaboost.pkl',
        #"Stochastic Gradient Boosting": 'pickle_files/SGB.pkl',
        "Voting Ensemble": 'pickle_files/voting_ensemble.pkl',
        "Naive Bayes": 'pickle_files/naive_bayes.pkl',
        "SVM": 'pickle_files/SVM.pkl'
    }

    results = {}

    for model_name, model_path in models.items():
        print("Prediction using %s Model" % model_name)
        clf = joblib.load(model_path)
        y_pred = clf.predict(dfnew)
...
# print_main_menu()
choice = 1  # Set the default choice to 2
# print(Fore.BLUE + "Enter your choice: ", choice)
pprint.pprint("feature of the mail " + ", ".join(map(str, features_list)), width=1)
